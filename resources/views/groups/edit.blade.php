<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Modifier Groupe</h2>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('groups.update', $group) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" value="{{ old('name', $group->name) }}" required class="w-full border rounded px-3 py-2">
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium mb-2">Description</label>
                            <textarea name="description" class="w-full border rounded px-3 py-2">{{ old('description', $group->description) }}</textarea>
                        </div>
